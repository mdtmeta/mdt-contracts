...
contract MDT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500_0000_0000_0000 * 10**9;
    ...
    constructor(address router_) Ownable() {
    ...
    function createUniswapV2Pair(address swapToToken_) public {
        require(
            swapToToken == address(0x0),
            "Uniswap pair is already created."
        );
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 initialBalance = IERC20(swapToToken).balanceOf(address(this));

        // swap tokens for ETH
        swapTokens(half); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered

        // how much ETH did we just swap into?
        uint256 newBalance = IERC20(swapToToken).balanceOf(address(this)).sub(
            initialBalance
        );
